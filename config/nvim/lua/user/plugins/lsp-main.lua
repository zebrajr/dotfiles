return {
    ...
    config = function()
        vim.api.nvim_create_autocmd('LspAttach', {
            ...
            -- function to help define mappings for LSP related items
            -- sets the mode and the description every time
        ...
        -- loads the lsp servers that are defined
        local servers = require('user/plugins/lsp-servers')

        -- ensure tools and servers are installed
        require('mason').setup()
